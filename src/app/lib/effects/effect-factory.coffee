define (require, exports, module) ->
  ...
  MoveEffect = require 'cs!app/lib/effects/move-effect'
  TurnEffect = require 'cs!app/lib/effects/turn-effect'
  CrushEffect = require 'cs!app/lib/effects/crush-effect'
  FallEffect = require 'cs!app/lib/effects/fall-effect'
